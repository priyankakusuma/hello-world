...
def fetch_kpi_data(request):
    ...
    # PE Ratio
    # eps = company_info.get("epsTrailingTwelveMonths")
    # pe_ratio = current_stock_price / eps if eps and eps > 0 else None
    # response_data["pe_ratio"] = round(pe_ratio, 2) if pe_ratio else "N/A"
